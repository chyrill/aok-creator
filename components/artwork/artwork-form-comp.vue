                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    <div style="text-align: center">
                                        ...
                                        <v-btn class="_btn black" style="height: 75px; font-weight: 700" :dark="!invalidform" :disabled="invalidform" block @click="submit">Post</v-btn>
                                    </div>
                                </v-card-text>
                            </v-card>
                        </v-flex>
...
import ADD_ARTWORK from '@/graphql/artwork/addartwork'
...
export default {
    ...
    methods: {
        ...
        async submit () {
            ...
            .then(res => {
                const { Model, Successful, Message } = res.data.addartwork
                if(!Successful) {
                    this.triggerLoading()
